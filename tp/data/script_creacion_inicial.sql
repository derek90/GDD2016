...
IF (OBJECT_ID ('HARDCOR.listar_usuarios') IS NOT NULL)
  DROP PROCEDURE HARDCOR.listar_usuarios
...
CREATE PROCEDURE HARDCOR.listar_usuarios(@pagina INT, @cantidad_resultados_por_pagina INT) AS BEGIN
